...
(function () {
  ...
  const INTENTS = [
    ...
    { k: ["deal", "cheap", "cheapest", "save money", "discount", "offer", "budget"], t: "Best value is the £4.99/mo Insider membership — 15% off every beat, cover and service, so it pays for itself fast.", href: "account.html", cta: "Get 15% off" },
