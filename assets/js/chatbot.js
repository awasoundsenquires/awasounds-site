...
(function () {
  ...
  const INTENTS = [
    ...
    { k: ["buy", "purchase", "checkout", "check out", "pay", "order", "get it now", "cop"], t: "Easy — pick a beat or a cover, hit License / Buy, and you're sorted. Every beat comes with its contract, and Insider members save 15% on the lot.", href: "beat-store.html", cta: "Start with beats" },
    { k: ["deal", "cheap", "cheapest", "save money", "discount", "offer", "budget"], t: "Best value is the £4.99/mo Insider membership — 30% off cover art and 15% off beats and services, so it pays for itself fast.", href: "account.html", cta: "Get the discount" },
    { k: ["member", "membership", "insider", "subscribe", "discount"], t: "The £4.99/mo Insider membership gets you 30% off cover art and 15% off beats and services, plus playlists and saved items.", href: "account.html", cta: "Become an Insider" },
